    ...
    private static class Handler implements Runnable {
        ...
        public void run() {
            try {
            	...
            	System.out.println("Accepted name : "+name);
                ...
                while (true) {
                    ...
                    }else if(input.startsWith("NAMELIST")) {
                    	String user = input.substring(9);
                    	String Second;
                    	Second = in.readLine();
                    	
                       	if (Second.startsWith("TEXTFIELD")) {
                        	
                    		String msg = Second.substring(10);
                ...
                System.out.println("Remove Client application : "+ name);
